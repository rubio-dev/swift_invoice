            ...
            <div class="card-body px-2 py-2">
                ...
                <form method="POST" action="save.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="mother_last_name" name="mother_last_name" class="form-control" readonly
                            pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]{1,50}" title="Solo letras y espacios"
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" class="form-control" pattern="[0-9]{10}"readonly
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="rfc" name="rfc" class="form-control" readonly
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" name="address" class="form-control" readonly
