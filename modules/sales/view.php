...
// 1) Obtener información de la venta y del cliente (persona o empresa)
$stmt = $conn->prepare("
    SELECT 
      s.*,
      CASE 
      ...
      <div class="card-body">
        <div class="row mb-4">
          ...
          <div class="col-md-6">
            ...
            <p><strong>IVA (<?php echo htmlspecialchars($sale['tax_percentage']); ?>%):</strong> $<?php echo number_format($sale['tax_amount'], 2); ?></p>
