...
<main class="d-flex align-items-center justify-content-center min-vh-100">
    <div class="company-container w-100" style="max-width: 1100px;">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="business_name" name="business_name" class="form-control" value="<?php echo htmlspecialchars($company['business_name']); ?>" required>
                            <?php if (isset($errors['business_name'])): ?><span class="error-text"><?php echo $errors['business_name']; ?></span><?php endif; ?>
                        </div>

                        <div class="form-group">
                            <label for="rfc">RFC:</label>
                            <input type="text" id="rfc" name="rfc" class="form-control" value="<?php echo htmlspecialchars($company['rfc']); ?>" required>
                            <?php if (isset($errors['rfc'])): ?><span class="error-text"><?php echo $errors['rfc']; ?></span><?php endif; ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if (isset($errors['fiscal_address'])): ?><span class="error-text"><?php echo $errors['fiscal_address']; ?></span><?php endif; ?>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="legal_representative" name="legal_representative" class="form-control" value="<?php echo htmlspecialchars($company['legal_representative']); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="business_type_id" name="business_type_id" class="form-control" required>
                                ...
                                <?php foreach ($business_types as $type): ?>
                                    <option value="<?php echo $type['id']; ?>" <?php echo ($company['business_type_id'] == $type['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($type['name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="tax_regime_id" name="tax_regime_id" class="form-control" required>
                                ...
                                <?php foreach ($tax_regimes as $regime): ?>
                                    <option value="<?php echo $regime['id']; ?>" <?php echo ($company['tax_regime_id'] == $regime['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($regime['name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
